...
import './operator.css';
import asrs from 'C:/Users/gauri/OneDrive/Documents/IRP1/gui_smartAssemblyLine/frontend/src/operator/Viper.jpg';
...
function StatusVision() {
        ...
        const fetchProductionDetails = async () => {
            try {
                const response = await axios.get('https://gui-smartassemblyline-1.onrender.com/productionDetails', {
                    params: { machineId: 4, productionId},
                });
    ...
    return (
        <div className="operator">
            ...
            <img src={logo} alt="Logo" className="logo" style={{width: '100px', height: '80px', marginLeft: '4%'}}/>
            ...
            <div className="container">
                ...
                {/* Right panel with current order and machine details */}
                <div className="right-panel">
                    <div className="current-order">
                        ...
                        <div className="current-order-info">
                            ...
                            <img src={asrs} alt="ASRS System" width={200} />
                        </div>
