...
import './operator.css';
import asrs from 'C:/Users/gauri/OneDrive/Documents/IRP1/gui_smartAssemblyLine/frontend/src/operator/asrs.webp';
        ...
        const fetchProductionDetails = async () => {
            try {
                const response = await axios.get('https://gui-smartassemblyline-1.onrender.com/productionDetails', {
                    params: { machineId: 1, productionId:productionId},
                });
        ...
        <div className="operator">
            ...
            <img src={logo} alt="Logo" className="logo" style={{width: '100px', height: '80px', marginLeft: '5%'}}/>
                <nav className="nav-links">
                    <Link to='/statusAsrsRM' className='Nav-link' style={{fontSize: '20px'}}>Edit</Link>
